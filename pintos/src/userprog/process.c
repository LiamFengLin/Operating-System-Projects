...
/* Loads an ELF executable from FILE_NAME into the current thread.
  ...
  /* Open executable file. Deny write and keep it open if it's not NULL.. */
...
/* This is similar to wc, which returns the number of words in a string, with space as splitter.
    Multiple continuous space is counted as one space. 
    Space at the beginning and end are ignored.*/
...
/* Create a string which is the arg_num^th argument in the charsequence args
  Remember to free*/
...
/* Check if the stack has enough room to let all arguments of the exec() be pushed.
    */
