...
/**
 * This NetworkHandler will asynchronously handle the socket connections. Uses a
 * thread pool to ensure that none of its methods are blocking.
 */
public class ServerClientHandler implements NetworkHandler {
	 ...
	 *
	 * @param kvServer
	 *            KVServer to carry out requests
	 */
	...
	/**
	 * Constructs a ServerClientHandler with ThreadPool of thread equal to the
	 * number passed in as connections.
	 *
	 * @param kvServer
	 *            KVServer to carry out requests
	 * @param connections
	 *            number of threads in threadPool to service requests
	 */
	 ...
	 *
	 * @param client
	 *            Socket connected to the client with the request
	 */
	@Override
